...
async def on_mention(note):
    if note["reply"] is not None:
        ...
        if targetnote is not None:
            ...
            Mode = "ToPule"
            if len(notetext.replace("ぷぇ","").replace("ぷぅ","").replace("ぷえぇ","").replace("ぷえ","").replace("みぃ","").replace("ぷぅえ","").replace("ぷぃ","").replace("ぷぅい","").replace("ぷみ","").replace("～","").replace("~","").replace("？","").replace("?","").replace("！","").replace("!","").replace(" ","").replace("\n","").replace("\r","")) <= 0:
                Mode = "ToJP"
